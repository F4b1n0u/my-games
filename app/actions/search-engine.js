...
export const REQUEST_FRANCHISE_COMPLETION_SUCCESS = 'my-games/search-engine/REQUEST_FRANCHISE_COMPLETION_SUCCESS'
export const REQUEST_FRANCHISE_COMPLETION_FAILURE = 'my-games/search-engine/REQUEST_FRANCHISE_COMPLETION_FAILURE'
...
export const receiveFranchiseCompletion = (completedFranchise) => ({
  type: REQUEST_FRANCHISE_COMPLETION_SUCCESS,
  completedFranchise,
})

export const receiveFranchiseCompletionFailure = (error) => ({
  type: REQUEST_FRANCHISE_COMPLETION_FAILURE,
  error
})
